...
- 23 个独立的 `gtohjs` 物品：配方编辑器、自定义多方块结构导出器、真空覆盖、3 个预装 AE 元件包、整体青铜框架和 16 个世界碎片。
...
- 注册或代理 768 条配方：254 条碎片世界采集、408 条批量锻造锤、71 条 Botania 代理、22 条工作台有序配方、4 条化学污泥、1 条污泥电解、3 条稀土、2 条 ME 总成和 3 条导入机器配方。
...
- 元件包：分别包含 123、42 和 21 种物品；每种物品数量为 `16,777,216`；电量为 `20,000`；使用独立的外部存储 UUID，并支持原位内容迁移。
