...
Third-party mod JARs are intentionally excluded from this repository. Obtain them from a legal GTO 0.5.6-beta development installation and place them in this directory with these exact names:
