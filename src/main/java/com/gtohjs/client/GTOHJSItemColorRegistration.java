...
/** Reuses AE2's LED and housing tint behavior for the two custom portable cells. */
...
public final class GTOHJSItemColorRegistration {
    ...
    public static void registerItemColors(RegisterColorHandlersEvent.Item event) {
        event.register(GTOHJSItemColorRegistration::portableCellColor,
                GTOHJSItems.NORMAL_AE_COMPONENT_PACK.get(),
                GTOHJSItems.SUPER_AE_COMPONENT_PACK.get());
    }
